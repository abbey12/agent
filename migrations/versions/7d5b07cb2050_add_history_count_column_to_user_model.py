"""Add history_count column to User model

Revision ID: 7d5b07cb2050
Revises: 72109e20cef2
Create Date: 2024-11-11 03:23:56.605884
...
revision = '7d5b07cb2050'
down_revision = '72109e20cef2'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('facility_name', sa.VARCHAR(length=200), nullable=True))
